...
def onethread_run_ssh(user, password, host, port, workdir, command):
    ...
    spec_cmd = "ssh -p {} -tt -o PreferredAuthentications=password -o PubkeyAuthentication=no -o StrictHostKeyChecking=no {} {}@{} ".format(
...
def run_ssh(host, cmd, passwd):
    ...
    try:
        ...
        _ = child.sendline(base64.b64decode(passwd)[:-1])
    except pexpect.EOF:
        # print("pexpect.EOF")
